          ...
          {contactInfo?.map((info, index) => {
            ...
            return (
              <Card
                ...
                className="group bg-[#3c570a] hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
              >
                <CardContent className="p-6 text-center">
                  <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#fff] text-[#3c570a] mb-4 group-hover:scale-110 transition-transform">
