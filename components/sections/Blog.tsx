...
export default function Blog() {
  ...
  return (
    <section id="blog" className="py-20 px-4 relative z-20">
          ...
          {items?.map((item:any, index:number) => (
            ...
            >
              ...
              <div className="relative h-52 overflow-hidden">
                ...
                >
                  <button
                    ...
                    className="absolute top-3 right-3 w-10 h-10 bg-[#566b30] hover:bg-[#566b30c9] text-white rounded-full flex items-center justify-center shadow-lg transition hover:scale-110"
                  >
                    <svg
              ...
              <div className="p-5">
                ...
                >
                  <button className="w-full py-2 bg-gray-50 text-gray-800 text-sm font-semibold rounded-lg hover:bg-[#566b30c9] hover:text-white transition-colors">
                    View Details
                  </button>
                </Link>
              </div>
