...
const applyPromoCode = async () => {
  ...
  try {
    const res = await axiosInstance.post("/user/promo-code", {
    ...
    if (res?.data?.data) {
      ...
      toast.error(res.data?.message || "No discount available for this promo code");
    }
  } catch (err: any) {
    setDiscountData(null);
                ...
                >
                  ...
                  <div className="flex items-center justify-between w-full sm:w-auto space-x-8">
                    ...
                    <div className="flex items-center bg-gray-50 rounded-full px-3 py-1 border border-gray-200">
                      ...
                      <span className="font-bold px-4 text-gray-800">
                        {item?.quantity}
                      </span>
                      <button
